...
class GraphQLInstrumentation extends instrumentation_1.InstrumentationBase {
    ...
    _executeResponseHook(span, result) {
        ...
        instrumentation_1.safeExecuteInTheMiddle(() => {
            ...
            utils_1.endSpan(span, undefined);
        }, true);
    }
    _patchParse() {
        const instrumentation = this;
    ...
    _createExecuteSpan(operation, processedArgs) {
        ...
        if (operation) {
            const name = operation
                .operation;
            if (name) {
                span.setAttribute(AttributeNames_1.AttributeNames.OPERATION, name);
            }
        }
        else {
            let operationName = ' ';
            ...
            span.setAttribute(AttributeNames_1.AttributeNames.OPERATION, operationName);
        }
